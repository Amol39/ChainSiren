...
const FaqComponent = () => {
	...
	const [data, set_data] = useState([
		...
		{"key:":2,"ques":"How to Buy Cryptocurrency on ChainSiren P2P?" ,"ans":"You can now buy cryptocurrencies using Indian Rupees with 0 transaction fees on ChainSiren P2P! Follow this guide for Weband App."},
